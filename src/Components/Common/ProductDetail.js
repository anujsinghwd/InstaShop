        ...
        return (
            ...
            <div className="container bgwhite p-t-35 p-b-80">
                        ...
                        <div className="wrap-slick3 flex-sb flex-w">
                            ...
                            <div className="slick3 slick-initialized slick-slider slick-dotted">
                                <div className="slick-list draggable">
                                    <div className="slick-track" style={{opacity: 1, width: '981px'}}>
                                        <div className="item-slick3 slick-slide slick-current slick-active" data-thumb="images/thumb-item-01.jpg" data-slick-index={-1} aria-hidden="false" tabIndex={-1} role="tabpanel" id="slick-slide10" aria-describedby="slick-slide-control10" style={{width: '327px', position: 'relative', left: '0px', top: '0px',zIndex : '999', opacity: 1}}>
                                            <div className="wrap-pic-w">
                                                <img src={`${data.images.high}`} alt="IMG-PRODUCT" />
                                            </div>
                                        </div>
                                        <div className="item-slick3 slick-slide" data-thumb="images/thumb-item-02.jpg" data-slick-index={1} aria-hidden="true" tabIndex={0} role="tabpanel" id="slick-slide11" aria-describedby="slick-slide-control11" style={{width: '327px', position: 'relative', left: '-327px', top: '0px', zIndex: '998', opacity: 0}}>
                                            <div className="wrap-pic-w">
                                                <img src={`${data.images.high}`} alt="IMG-PRODUCT" />
                                            </div>
                                        </div>
               ...
               <i class="down-mark fs-12 color1 fa fa-minus dis-none" aria-hidden="true"></i>
                ...
                <section classNameName="relateproduct bgwhite p-t-45 p-b-138">
                <div classNameName="container">
                     <div classNameName="sec-title p-b-60">
                            <h3 classNameName="m-text5 t-center">
                                 Related Products
                            </h3>
                     </div>
                     
                     <div classNameName="wrap-slick2">
                            
                            <div classNameName="slick2 slick-initialized slick-slider">
                                 <div classNameName="slick-list draggable">
                                        <div classNameName="slick-track">
                                            {cards}
                                    </div>
                                    </div>
                            </div>
