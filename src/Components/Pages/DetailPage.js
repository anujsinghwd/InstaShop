...
class DetailPage extends Component {
  render() {
	...
	let cards;
	cards = response.response.splice(0, 5).map((r, i) => {
		return (r.id != data.id) ? <Card data={r} key={i} response={response} /> : ''
	})
    return (
        <>
	...
	{/* <RelatedProduct data={this.props.location.state.response}/> */}
	{
	 cards	
	}
    </>
